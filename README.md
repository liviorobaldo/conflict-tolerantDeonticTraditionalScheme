...
<p align="justify">
To re-execute the examples locally you must have Java installed. The source code downloadable from this GitHub repository has been developed using Java v.19 but it should work also with other versions of the Java Runtime Environment.
</p>
